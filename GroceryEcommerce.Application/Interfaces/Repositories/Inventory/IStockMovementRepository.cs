...
public interface IStockMovementRepository
{
    ...
    Task<Result<PagedResult<StockMovement>>> GetByWarehouseIdAsync(Guid warehouseId, PagedRequest pagedRequest, CancellationToken cancellationToken = default);
    ...
    Task<Result<PagedResult<StockMovement>>> GetByProductAndWarehouseAsync(Guid productId, Guid warehouseId, PagedRequest pagedRequest, CancellationToken cancellationToken = default);
