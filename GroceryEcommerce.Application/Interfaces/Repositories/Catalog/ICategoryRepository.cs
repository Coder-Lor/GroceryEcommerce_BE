...
public interface ICategoryRepository : IPagedRepository<Product>
{
    ...
    Task<Result<(bool ExitsByName, bool ExitsById)>> ExistsAsync(string name, Guid categoryId, CancellationToken cancellationToken = default);
