...
public interface IWishlistRepository
{
    ...
    Task<Result<PagedResult<Wishlist>>> GetByUserIdAsync(PagedRequest request, Guid userId, CancellationToken cancellationToken = default);
    ...
    Task<Result<PagedResult<Wishlist>>> GetPublicWishlistsAsync(PagedRequest request, CancellationToken cancellationToken = default);
    Task<Result<PagedResult<Wishlist>>> GetPublicWishlistsByUserIdAsync(PagedRequest request, Guid userId, CancellationToken cancellationToken = default);
