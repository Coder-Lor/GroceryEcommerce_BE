...
{
    // Order operations
    Task<Result<PagedResult<Order>>> GetOrdersAsync(PagedRequest request, CancellationToken cancellationToken = default);
    Task<Result<List<Order>>> GetOrdersByUserIdAsync(Guid userId, CancellationToken cancellationToken = default);
    ...
    Task<Result<List<Order>>> GetOrdersByStatusAsync(short status, CancellationToken cancellationToken = default);
    Task<Result<List<Order>>> GetOrdersByDateRangeAsync(DateTime fromDate, DateTime toDate, CancellationToken cancellationToken = default);
    ...
    Task<Result<OrderItem>> CreateOrderItemAsync(OrderItem orderItem, CancellationToken cancellationToken = default);
    ...
    Task<Result<OrderStatusHistory>> CreateOrderStatusHistoryAsync(OrderStatusHistory statusHistory, CancellationToken cancellationToken = default);
    ...
    Task<Result<OrderPayment>> CreateOrderPaymentAsync(OrderPayment payment, CancellationToken cancellationToken = default);
    ...
    Task<Result<OrderShipment>> CreateOrderShipmentAsync(OrderShipment shipment, CancellationToken cancellationToken = default);
    ...
    Task<Result<ShipmentItem>> CreateShipmentItemAsync(ShipmentItem shipmentItem, CancellationToken cancellationToken = default);
    ...
    Task<Result<ShipmentCarrier>> CreateShipmentCarrierAsync(ShipmentCarrier carrier, CancellationToken cancellationToken = default);
    ...
    Task<Result<OrderRefund>> CreateOrderRefundAsync(OrderRefund refund, CancellationToken cancellationToken = default);
